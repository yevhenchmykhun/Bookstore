...
2. Run the SQL scripts found in src/main/webapp/setup directory. The schema script creates tables necessary for the     application. The data script adds sample data to the tables. Run the schema creation script first, then run the sample data script.
...
3. Download Tomcat server from http://tomcat.apache.org/
    ...
    docBase value in <param-value> of <context-param> with <param-name>absoluteCoversPath</param-name>
    and 
